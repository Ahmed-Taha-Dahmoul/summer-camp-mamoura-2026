      ...
      <div className="wheel-hero-section">
        <div className="container text-center">
          ...
          <h1 className="premium-title mb-2">
            Roulette <span className="gradient-text text-amber-500">Kechfa</span>
          </h1>
          <p className="premium-subtitle" style={{ maxWidth: '400px', margin: '0 auto', fontSize: '1.1rem' }}>
            Tentez votre chance ! Tournez la roue toutes les 5 heures pour gagner des points pour votre patrouille.
          </p>
        </div>
      </div>
